        ...
        <Tabs :animated="false" value="name3" type="line" @on-click="eee">
            ...
            <TabPane label="设备" name="name2" style="height:300px">
                <Row :gutter="16">
                    ...
                    <Col span="4">
                    <Date-picker type="daterange" @on-change="getDate" format="yyyy/MM/dd" placeholder="选择日期和时间"></Date-picker>
                    </Col>
                    <Col span="1">
                ...
                <Table :loading="loading"  :data="tableData1" :columns="tableColumns1" stripe @on-selection-change="bb"></Table>
